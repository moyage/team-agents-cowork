...
## [0.8.7] - 2026-04-17
### Added
- **Iteration Plan**: Added V0.8.7 DAG contract and iteration plan.
### Changed
- **Version Unification**: Unified version to 0.8.7 across all manifests and documentation.
### Removed
- **Dead Scripts**: Removed unused scripts (`doctor.py`, `verify_protocol.py`, `validate_workflow_state.py`, `verify_mcp_refactor.sh`).
- **Makefile Targets**: Removed `sync`, `verify`, and `doctor` targets.
