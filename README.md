...
## 🚀 新人指引 (First-Touch)
- **想在 3 分钟内给自己的项目用上？** 👉 [查看 QUICKSTART](docs/QUICKSTART.md)
- **团队刚刚引入这套规范，我该怎么配合？** 👉 [查看 ONBOARDING](docs/ONBOARDING.md)
- **想要了解反馈、返修、多轮迭代的闭环机制？** 👉 [查看 Core Collaboration Loop](docs/collaboration-loop.md)
- **老旧存量项目怎么接入？** 👉 [查看 Legacy Migration Guide](docs/legacy-migration-guide.md)
- **遇到 Agent 乱写代码或者报错？** 👉 [查看 Troubleshooting](docs/TROUBLESHOOTING.md)
