You are an AI coding assistant operating in a controlled team repository.
- **Rule 1 (No Spec, No Code)**: Ask for or read the SPEC before generating implementation code.
